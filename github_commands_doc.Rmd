...
git pull --rebase
```
see (http://kernowsoul.com/blog/2012/06/20/4-ways-to-avoid-merge-commits-in-git/){http://kernowsoul.com/blog/2012/06/20/4-ways-to-avoid-merge-commits-in-git/}, for setting this up permanently
